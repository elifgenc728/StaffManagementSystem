...
class _NewJobPageState extends State<NewJobPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonControlProvider = Provider.of<ButtonControlProvider>(context);
    return  Scaffold(
          floatingActionButton:
              buttonControlProvider.buttonIsActive
  ...
  CustomBorderTextField _buildMessageTextField(buttonControlProvider) {
    return CustomBorderTextField(
      ...
      textEditingController: buttonControlProvider.messageTextEditingController,
      labelText: "Mesaj",
  ...
  CustomBorderTextField _buildSubjectTextField(buttonControlProvider) {
    return CustomBorderTextField(
      ...
      textEditingController: buttonControlProvider.subjectTextEditingController,
      labelText: "Konu",
